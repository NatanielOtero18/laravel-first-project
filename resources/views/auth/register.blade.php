<x-layouts.app title="Register" meta-description="Register">
    ...
    <form class="max-w-xl px-8 py-4 mx-auto bg-white rounded shadow " action="{{ route('register') }}" method="POST">
        @csrf

        <div class="space-y-4">
            <label class="flex flex-col">
                <span class="font-serif text-slate-600 ">Name</span>
            ...
            <label class="flex flex-col">
                <span class="font-serif text-slate-600 ">Confirm Password</span>
                <input
                    class="rounded-md shadow-sm border-slate-300  text-slate-600  focus:ring focus:ring-slate-300  focus:ring-opacity-50  focus:border-slate-300 "
